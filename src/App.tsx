              ...
              >
                ...
                <div className="relative overflow-hidden rounded-[24px] shadow-xl border border-slate-100 min-h-[480px] md:h-[520px] flex items-center group shrink-0 bg-slate-950">
                  ...
                  <img
                    ...
                    className="absolute inset-0 h-full w-full object-cover object-center contrast-[1.03] saturate-[1.05] brightness-[0.98] transition-transform duration-1000 group-hover:scale-101 z-0"
                  />
